...
describe(`Cadastrar Usuario`, () => {
	...
	describe(`Validar se é permitido cadastro de usuário escolhendo 'Tecnico' da opção de 'permissao'`, () => {
		const data = { endpoint: '/cadastrar', nome: 'UsuarioTecnico', senha: '12345678', permissao: 'Técnico' };
