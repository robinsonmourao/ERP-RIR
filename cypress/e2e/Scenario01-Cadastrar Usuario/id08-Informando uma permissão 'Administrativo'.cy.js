...
describe(`Cadastrar Usuario`, () => {
	...
	describe(`Validar se é permitido cadastro de usuário escolhendo 'Administrativo' da opção de 'permissao'`, () => {
		const data = { endpoint: '/cadastrar', nome: 'UsuarioAdministrativo', senha: '12345678', permissao: 'Administrativo' };
