...
And('#005002 eu esteja na tela de visão geral da conta.') do
  @visao_geral_conta_page = VisaoGeralContaPage.new
  @visao_geral_conta_page.load
  @visao_geral_conta_page.clicar_visao_geral_conta
end

When("#005002 eu clicar em Fechar minha conta") do
  @visao_geral_conta_page.clicar_deletar_conta_link
end
And("#005002 eu preencha o campo com uma senha incorreta password {string}.") do |password|
  @visao_geral_conta_page.preencher_dados(password)
  @visao_geral_conta_page.clicar_fechar_conta_button
end

Then('#005002 eu vejo uma mensagem dizendo que a senha que informei está incorreta.') do
