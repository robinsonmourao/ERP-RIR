...
E('#0901: eu já tenha criado um Cliente, Site, Fornecedor, Atendimento, Status e Fatura com valores alternativos') do
  ...
  SetUp.status('fornecedor_alternativo', 'Fornecedor', 'Pendente')
  SetUp.fatura('001RIR2 002fornecedor_alternativo', '001f 002fornecedor_alternativo 003Pendente', 'Boleto', 'Fatura não agrupada', '2024-08-25')
end
