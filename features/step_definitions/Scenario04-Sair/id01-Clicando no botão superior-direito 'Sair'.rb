...
When('#0401 eu clicar no botão Sair.') do
  @dashboard_page.clicar_sair
end

Then('#0401 eu sou redirecionado para tela entrar') do
...
And('#0401 eu vejo uma mensagem laranja me informando que fui desconectado!') do
