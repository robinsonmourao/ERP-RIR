...
E('#0601: eu tiver clicado em {string}.') do |link_text|
...
Então('#0601: eu sou redirecionado para detalhes do novo Atendimento criado contendo valores informados e valores autopreenchidos') do
  expected_values = {
    '#designacao-value' => 'RIR', '#velocidade_down-value' => '10',

    '#ip-value' => 'IP Dinâmico', '#link-value' => 'Principal',
    '#dia_vencimento-value' => '25', '#nota_fiscal-value' => 'Inexistente'
  }
