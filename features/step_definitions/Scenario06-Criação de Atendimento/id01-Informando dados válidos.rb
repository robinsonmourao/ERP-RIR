...
begin
  ...
  Então('#0601: eu sou redirecionado para detalhes do novo Atendimento criado') do
    within '.detalhes-items-cells_values-show' do
      expect(page).to have_css('.detalhes-planilha-celula', text: 'RIR')
      expect(page).to have_css('.detalhes-planilha-celula', text: '10')
      expect(page).to have_css('.detalhes-planilha-celula', text: 'IP Dinâmico')
      expect(page).to have_css('.detalhes-planilha-celula', text: 'Principal')
      expect(page).to have_css('.detalhes-planilha-celula', text: '25')
      expect(page).to have_css('.detalhes-planilha-celula', text: 'Inexistente')
    end
  end
