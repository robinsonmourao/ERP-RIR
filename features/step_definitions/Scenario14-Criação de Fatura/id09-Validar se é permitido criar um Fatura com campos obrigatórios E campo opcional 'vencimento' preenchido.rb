...
E('#1409: eu preencher o campo data de pagamento {string}') do |formated_date|
...
Então('#1409: eu sou redirecionado para detalhes da nova Fatura criada contendo valores informados') do
  expected_values = { '#codigo_fatura_composto-value' => "001(001RIR 002fornecedor_principal) 0022024-08-10 003Fatura não agrupada",
                      '#codigo_meio_pagamento-value' => 'Boleto',
                      '#vencimento-value' => '2024-08-10',
...
E('#1409: eu vejo a informação de que a Fatura foi criada com sucesso contendo o valor de código fatura composto.') do
  ...
  expect(@message.text).to eql "Fatura com codigo fatura composto '001(001RIR 002fornecedor_principal) 0022024-08-10 003Fatura não agrupada' foi criado com sucesso."
end
